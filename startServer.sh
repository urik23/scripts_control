...
docker-machine create -d digitalocean --digitalocean-access-token $DIGITAL_OCEAN_TOKEN --swarm --swarm-discovery $SWARM_TOKEN swarm-node-`etcdctl get /GLOBAL/SERVER_NUM`
